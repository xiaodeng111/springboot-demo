    ...
    <div class="col-md-6 ui-sortable" style="width:100%;">
        ...
        <div class="panel panel-inverse">
            <div class="panel-header">
                ...
                <h4 class="panel-title not-line">${requestScope.title}-编辑</h4>
            </div>
             <div class="panel-body panel-form">
                  <form data-parsley-validate="true" name="schoolForm" id="schoolForm" method="post" action="${base}/admin/news/edit" onsubmit="return checkForm();" class="form-horizontal form-bordered" data-validate="parsley">
                    ...
                    <input type="hidden" name="pageSize" id="commonPageSize" value="${requestScope.pageSize}"/>
                      ...
                      <input type="hidden" name="type" id="type" value="${requestScope.news.type}"/>
                    <div class="form-group">
                        <label class="control-label col-md-2 col-sm-4 ui-sortable" ><span style="color: red">*</span>标题：</label>
                        <div class="col-md-6 col-sm-6 ui-sortable">
                            <input name="name" maxlength="20" data-parsley-required="true" value="${requestScope.news.name }" type="text" id="name" ltype="text" class="form-control parsley-validated"  style="width:300px;"  placeholder="请输入不超过20位"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ui-sortable">
                            ...
                            <div class="nav-padding-top">
                                ...
                                <c:if test="${requestScope.news.type == 2}">
                                    <img src="" id="group-img"  width="200"  height="100"  class="hidden">
                                ...
                                <c:if test="${requestScope.news.type == 3 || requestScope.news.type == 4}">
                                    <img src="" id="group-img"  width="100"  height="100"  class="hidden">
                      ...
                      <c:if test="${requestScope.news.type != 2}">
                          <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 ui-sortable">
                                  <input name="jumpUrl" maxlength="128" type="text" placeholder="链接以https://或者http://开头"  value="${requestScope.news.jumpUrl }" id="jumpUrl" ltype="text"  <c:if test="${requestScope.news.type == 3 || requestScope.news.type == 4}">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2 col-sm-4 ui-sortable" ><span style="color: red">*</span>副标题：</label>
                        <div class="col-md-6 col-sm-6 ui-sortable">
                            <input name="descIntroduction" maxlength="20" data-parsley-required="true" value="${requestScope.news.descIntroduction }" type="text" id="descIntroduction" ltype="text" class="form-control parsley-validated" style="width:400px;"  placeholder="请输入不超过20位"/>
                        </div>
                    </div>
                      <c:if test="${requestScope.news.type== 2}">
                          <div class="form-group">
                              <label class="control-label col-md-2 col-sm-4 ui-sortable" for="name">
                                ...
                                <%--  <div class="col-md-6 col-sm-6 ui-sortable">
                                      <textarea id="ckeditor" name="content" data-parsley-required="true">${requestScope.news.content }</textarea>
                                  </div>--%>
                              <div class="col-md-6 col-sm-6 ui-sortable">
                                  <textarea id="content" name="content">${requestScope.news.content}</textarea>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2 col-sm-4 ui-sortable"><span style="color: red">*</span>顺序号：</label>
                        <div class="col-md-6 col-sm-6 ui-sortable">
                            <input name="oderNum" maxlength="1" data-parsley-required="true" value="${requestScope.news.oderNum }" onkeyup="value=value.replace(/[^\d]/g,'')"
                                   ng-pattern="/[^a-zA-Z]/" type="text" id="oderNum" ltype="text" class="form-control parsley-validated" style="width:100px;" placeholder="请输入一位数"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ui-sortable">
                            <select id="status" name="status" class="formList width-150" onchange="statusChange(this)">
                                ...
                                <option value="0" <c:if test="${0 == requestScope.news.status}"> selected</c:if>>下架</option>
                                <option value="1" <c:if test="${1 == requestScope.news.status}"> selected</c:if>>上架</option>
                            </select>
                            <input type="text" id="status-hidden"  class="hidden-input" value="${requestScope.news.status}"
                                   data-parsley-required="true"
